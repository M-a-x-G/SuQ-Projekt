...
general.getScreenSize = function()
{
...
/**
 * Generalized Ajax Object for xmlHttpRequests.
 * Ajax works fine but is kindof "inappropriate".
 * In many cases it doesn't actually have to do with
 * XML anymore. -> Keeping an eye on Comet/Duplex for
